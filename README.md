...
*   **上传下载**: 文件上传、下载、获取直链、**流式代理下载**
*   **账号管理**: 登录 (BDUSS/Cookie)、扫码登录、切换账号、查看配额
*   **离线下载**: 添加任务、查询进度、取消任务
*   **回收站**: 查看、恢复、清空
*   **分享管理**: 创建分享、列出分享、取消分享、**转存分享链接**
*   **xpan API** (新): 基于 AccessToken 的文件列表和元数据查询
...
| 版本号 | 更新内容 |
|--------|----------|
| v1.3.2 (2025-12-27) | **新增**: xpan API 端点，支持基于 AccessToken 的文件列表和元数据查询 (`/api/xpan/files`, `/api/xpan/file/meta`) |
| v1.3.1 (2025-12-27) | **增强**: 彻底重写扫码登录 Cookie 提取逻辑，捕获所有 Set-Cookie (含 BAIDUID)，解决大文件下载 403 |
| v1.3.0 (2025-12-27) | **新增**: `/api/account/who` 返回完整 cookies 字段；**修复**: 流式下载 403 问题，支持 cookie 参数 |
| v1.2.3 (2025-12-27) | **新增**: 流式下载 API 支持 cookie 参数，解决浏览器防盗链 403 |
| v1.2.2 (2025-12-27) | **修复**: stream-download 使用 PCS 客户端携带认证 Cookies 修复 403 |
| v1.2.1 (2025-12-26) | **新增**: 流式下载代理 API，解决前端防盗链问题 |
| v1.2.0 (2025-12-25) | **修复**: API QR 码返回真实可扫描内容而非 URL |
| v1.1.0 (2025-12-24) | **新增**: 扫码登录支持（CLI + API），自动保存 BDUSS 和 STOKEN |
| v1.0.0 (2025-12-11) | 🎉 初始版本：BaiduPCS-Go HTTP API 项目启动 |
